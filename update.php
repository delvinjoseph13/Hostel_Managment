...
$sql3="SELECT * FROM course_details";
...
$sql1 = " UPDATE room SET room_no='$room_no',status ='$status' WHERE usn ='$usn' ";
...
<div class="mb-3">
    ...
    <input type="text" class="form-control"
    placeholder="enter the month of payment" name="fee_month" autocomplete="off" value=<?php echo $fee_amount;?>>
</div>
<div class="mb-3">
    <label>Course</label>
    <input type="text" class="form-control"
